...
class ViewPendingOrderList extends StatefulWidget {
  const ViewPendingOrderList({super.key});

  @override
  State<StatefulWidget> createState() {
    return _ViewPendingOrderList();
  }
}

class _ViewPendingOrderList extends State<ViewPendingOrderList> {
  ...
  late List<Order> postsFuture = openOrderListController.pendingOrder;
  ...
  void initState() {
    ...
    openOrderListController.getPendingOrders();
