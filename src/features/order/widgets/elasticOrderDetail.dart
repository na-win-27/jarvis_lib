...
class Elasticorderdetail extends StatefulWidget {
  int i;
  ...
  Elasticorderdetail(this.i, this.elastic, {super.key});

  @override
  State<Elasticorderdetail> createState() => _Elasticorderdetail(i,elastic);
}

class _Elasticorderdetail extends State<Elasticorderdetail> {
  int i;
  Map elastic;
  _Elasticorderdetail(this.i,this.elastic);
